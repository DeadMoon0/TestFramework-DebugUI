...
namespace WpfCommon
{
    ...
    public class GridLengthAnimation : AnimationTimeline
    {
        ...
        object defaultDestinationValue, AnimationClock animationClock)
        {
            ...
            if (fromVal > toVal) return new GridLength(1 - animationClock.CurrentProgress.Value * (fromVal - toVal) + toVal, this.From.IsStar ? GridUnitType.Star : GridUnitType.Pixel);
    ...
    public class ExpanderDoubleAnimation : DoubleAnimationBase
    {
        ...
        protected override double GetCurrentValueCore(double defaultOriginValue, double defaultDestinationValue, AnimationClock animationClock)
        {
            ...
            if (fromVal > toVal) return (1 - animationClock.CurrentProgress.Value) * (fromVal - toVal) + toVal;
            else return (animationClock.CurrentProgress.Value * (toVal - fromVal) + toVal);
        }
    }
}
